...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .booking-chip { display: block; padding: 3px 6px; margin-bottom: 3px; border-radius: 4px; font-size: 0.7rem; color: white; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; cursor: pointer; }
    ...
    .modal-title { font-size: 1.1rem; font-weight: 700; margin-bottom: 16px; color: #111; }
    .modal-grid { display: grid; grid-template-columns: 110px 1fr; gap: 6px 8px; font-size: 0.88rem; margin-bottom: 18px; }
    .modal-label { color: #888; font-weight: 500; }
    .modal-value { color: #222; font-weight: 600; }
    .modal-msg { font-size: 0.85rem; min-height: 20px; margin-bottom: 14px; }
    .modal-actions { display: flex; gap: 10px; justify-content: flex-end; }
    .btn { border: none; padding: 9px 18px; border-radius: 5px; cursor: pointer; font-size: 0.88rem; font-weight: 600; }
    .btn-cancel-res { background: #ef4444; color: white; }
    ...
    .btn-cancel-row { background: #ef4444; color: white; border: none; padding: 3px 10px; border-radius: 4px; cursor: pointer; font-size: 0.75rem; font-weight: 600; }
    .btn-cancel-row:hover { background: #dc2626; }
  </style>
</head>
<body>
  <div class="header">
...
function generateCalendarHTML(year, month, byDate) {
  ...
  let html = `<div class="month-nav"><h2>${monthNames[month]} ${year}</h2><button class="btn-schedule-month" data-year="${year}" data-month="${month}" onclick="scheduleMonth(this)">Schedule Month</button></div>`;
